...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Starblu — Medicina e Segurança do Trabalho" },
      {
        name: "description",
        content:
          "Medicina ocupacional, segurança do trabalho, SST e eSocial para empresas de Blumenau e região.",
      },
      { name: "author", content: "Starblu" },
      { property: "og:site_name", content: "Starblu" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#12213c" },
    ],
    links: [
      {
        rel: "stylesheet",
